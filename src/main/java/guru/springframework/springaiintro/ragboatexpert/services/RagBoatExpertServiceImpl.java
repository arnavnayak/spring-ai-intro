...
@Service
public class RagBoatExpertServiceImpl implements RagBoatExpertService {

    private final ChatModel chatModel;
    private final VectorStore vectorStore;

    @Value("classpath:/templates/rag-boat-expert-prompt-template.st")
    private Resource ragPromptTemplate;

    @Value("classpath:/templates/boat-expert-system-message.st")
    ...
    public Answer getAnswer(Question question) {
        ...
        Message userMessage = promptTemplate
                .createMessage(Map.of("input",question,"documents",String.join("\n",contentList)));
